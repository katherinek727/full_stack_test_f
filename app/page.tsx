...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-between px-8 sm:px-16 md:px-24 lg:px-40 py-2 pt-20 bg-[#072E6A]">
      <div>
        {/* Chat icon */}
        <div
        ...
        <p
          className="mt-6 mb-10 text-base leading-relaxed text-8xl"
          style={{ color: "var(--foreground-subtle)", fontSize: "25px", marginTop: "35px" }}
        >
